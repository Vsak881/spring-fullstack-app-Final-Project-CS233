...
## CS233 Final Project — NEXUS E-Commerce Platform

This document declares the use of AI tools during the development of this project, in accordance with course requirements.
...
AI was used as a **coding assistant and debugging partner**, not to generate the project autonomously. The developer:

- Described the project requirements and goals
...
- All git commits and version control
- Railway deployment configuration
- Testing and verification of all features
